<?php namespace Blupl\Sponsor;

use Orchestra\Sponsor\Providers\ServiceProvider;
...
//        $this->app->bind('Orchestra\Control\Contracts\Command\Synchronizer', 'Orchestra\Control\Command\Synchronizer');
    ...
    public function boot()
    {
        ...
        $this->addConfigComponent('blupl/sponsor', 'blupl/sponsor', $path.'/resources/config');
        $this->addLanguageComponent('blupl/sponsor', 'blupl/sponsor', $path.'/resources/lang');
        $this->addViewComponent('blupl/sponsor', 'blupl/sponsor', $path.'/resources/views');
...
//    }
    ...
    {
        $this->app['events']->listen('orchestra.ready: admin', 'Blupl\Sponsor\Http\Handlers\SponsorMenuHandler');
    }
...
//    }
    ...
    {
        $this->app['orchestra.extension.config']->map('blupl/sponsor', [
